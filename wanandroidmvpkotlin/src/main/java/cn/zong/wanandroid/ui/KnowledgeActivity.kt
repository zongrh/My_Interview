...
import cn.zong.wanandroid.bean.KnowledgeBean
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        intent.extras.let {
            if (it.get(Constant.data) is KnowledgeBean.Data) {
                ...
                val kDatas =
                    KnowledgeBean.Data.Children(data.chapterId, data.chapterName!!, 0, 0, 0, 0)
                var list = arrayListOf<KnowledgeBean.Data.Children>()
                list.add(kDatas)
