...
//            清除 cookie 、登录缓存
        ...
        if (supportFragmentManager.fragments.size == 0) {
            supportFragmentManager.beginTransaction().add(R.id.fl_container, homeFragment)
                .commitAllowingStateLoss()
            supportFragmentManager.beginTransaction().add(R.id.fl_container, knowledgeFragment)
                .commitAllowingStateLoss()
            supportFragmentManager.beginTransaction().add(R.id.fl_container, mineFragment)
                .commitAllowingStateLoss()
            supportFragmentManager.beginTransaction().hide(knowledgeFragment)
                .commitAllowingStateLoss()
        ...
        BottomNavigationView.OnNavigationItemSelectedListener { item ->
            when (item.itemId) {
                R.id.navigation_home -> {
                    ...
                    supportFragmentManager.beginTransaction().hide(knowledgeFragment)
                        .commitAllowingStateLoss()
                    supportFragmentManager.beginTransaction().hide(mineFragment)
                        .commitAllowingStateLoss()
                ...
                R.id.navigation_type -> {
                    supportFragmentManager.beginTransaction().hide(homeFragment)
                        .commitAllowingStateLoss()
                    supportFragmentManager.beginTransaction().show(knowledgeFragment)
                        .commitAllowingStateLoss()
                    supportFragmentManager.beginTransaction().hide(mineFragment)
                        .commitAllowingStateLoss()
